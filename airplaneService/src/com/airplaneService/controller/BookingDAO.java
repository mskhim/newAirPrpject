...
public class BookingDAO {
	private final String SELECT_SQL = "SELECT * FROM BOOKING_JOIN_ALL_VIEW ORDER BY TO_NUMBER(GROUP_NO)";
	...
	private final String SELECT_BY_CUSTOMER_SQL = "SELECT * FROM BOOKING_JOIN_ALL_VIEW WHERE CUSTOMER_NO = TO_CHAR(?,'FM0000000')  ";
